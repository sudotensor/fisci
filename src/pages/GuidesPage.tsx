...
export function GuidesPage(props: Props) {
  return (
    <div>
      ...
      <p>
        Use the{" "}
        <a href="https://www.gov.uk/business-coronavirus-support-finder">
          link
        </a>{" "}
      ...
      <p>
        Checkout how to{" "}
        <a href="https://www.nhscharitiestogether.co.uk/">Donate to NHS</a>.
        Your generous donation is going to change the lives of many.
      </p>
      <h3>Thrive for individuals</h3>
      <p>
        COVID is affecting everyone. The
        <a href="https://www.forbes.com/sites/brianmenickella/2020/05/01/6-financial-tips-for-surviving-covid-19/?sh=2140201a7825">
          tips from Forbes
        </a>
